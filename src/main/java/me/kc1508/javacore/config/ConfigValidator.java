...
public class ConfigValidator {
    ...
    public void validate() {
        ...
        changed |= checkStringDefault("hologram.messages.set.alignment.ok", "<green>Alignment set for <white>#%id%</white>.</green>");
        changed |= checkStringDefault("hologram.messages.set.alignment.invalid", "<red>Alignment must be left, center, or right.</red>");
        changed |= checkStringDefault("hologram.messages.set.billboard.ok", "<green>Billboard set for <white>#%id%</white>.</green>");
        ...
        changed |= checkStringDefault("hologram.messages.set.shadow.ok", "<green>Shadow set for <white>#%id%</white>.</green>");
        changed |= checkStringDefault("hologram.messages.set.shadow.fail", "<red>Failed to set shadow for <white>#%id%</white>.</red>");
        changed |= checkStringDefault("hologram.messages.set.see_through.ok", "<green>See-through set for <white>#%id%</white>.</green>");
        ...
        // --- Help request command (/ineedhelp)
        changed |= checkBooleanDefault("helpme.enabled", true);
        ...
        changed |= checkStringDefault("helpme.disabled-message", "<red>The help request command is disabled.</red>");
        changed |= checkStringDefault("helpme.cooldown-message", "<red>You must wait %seconds%s before using /ineedhelp again.</red>");
        changed |= checkStringDefault("helpme.ack-message", "<green>Help request sent to online operators.</green>");
        changed |= checkStringDefault("helpme.no-operators", "<yellow>No operators are currently online.</yellow>");
        changed |= checkStringDefault("helpme.default-message", "I need help.");
        changed |= checkStringDefault("helpme.broadcast", "<gray>[<gold>Help</gold>] <white>%player%</white>: %message%</gray>");
